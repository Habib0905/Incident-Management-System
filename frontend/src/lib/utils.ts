...
export const typeColors = {
  ...
  apache: 'bg-teal-100 text-teal-800 border-teal-200',
  api: 'bg-violet-100 text-violet-800 border-violet-200',
  queue: 'bg-amber-100 text-amber-800 border-amber-200',
  file: 'bg-stone-100 text-stone-800 border-stone-200',
  email: 'bg-rose-100 text-rose-800 border-rose-200',
  cache: 'bg-orange-100 text-orange-800 border-orange-200',
};
